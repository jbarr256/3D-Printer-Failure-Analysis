    ...
    <div>
        <v-card flat>
            <v-card-text>
                ...
                <v-divider class="my-2" />
                <settings-row
                    :title="$t('Settings.UiSettingsTab.ManualBrobeDialog')"
                    :sub-title="$t('Settings.UiSettingsTab.ManualBrobeDialogDescription')"
                    :dynamic-slot-width="true">
                    <v-switch v-model="boolManualBrobeDialog" hide-details class="mt-0" />
                </settings-row>
                <v-divider class="my-2" />
                <settings-row
...
export default class SettingsUiSettingsTab extends Mixins(BaseMixin) {
    ...
    set boolManualBrobeDialog(newVal) {
        this.$store.dispatch('gui/saveSetting', { name: 'uiSettings.boolManualBrobeDialog', value: newVal })
    }
