...
// node_modules/overlayscrollbars-vue/dist/overlayscrollbars-vue.esm.js
var import_overlayscrollbars = __toESM(require_OverlayScrollbars());
var OverlayScrollbarsComponent = class extends Vue.extend({
  ...
  mounted() {
    this._osInstace = (0, import_overlayscrollbars.default)(this.osTarget(), this.options || {}, this.extensions);
  },
  beforeDestroy() {
...
var __vue_script__ = OverlayScrollbarsComponent;
...
var OverlayScrollbarsPlugin = {
  install(vue, options) {
    if (options) {
      import_overlayscrollbars.default.defaultOptions(options);
    }
    vue.component("overlay-scrollbars", __vue_component__);
  }
};
export {
  __vue_component__ as OverlayScrollbarsComponent,
