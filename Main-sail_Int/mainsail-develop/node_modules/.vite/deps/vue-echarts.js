...
var w = { loading: Boolean, loadingOptions: Object };
var z = null;
var C = "x-vue-echarts";
var L = [];
var T = [];
...
var B = defineComponent({ name: "echarts", props: O(O({ option: Object, theme: { type: [Object, String] }, initOptions: Object, updateOptions: Object, group: String, manualUpdate: Boolean }, E), w), emits: {}, inheritAttrs: false, setup: function(t, i) {
  var a = i.attrs, p = shallowRef(), b2 = shallowRef(), E2 = shallowRef(), _2 = shallowRef(), w2 = inject(D, null), z2 = inject(U, null), C2 = inject(k, null), L2 = toRefs(t), T2 = L2.autoresize, B2 = L2.manualUpdate, P = L2.loading, H = L2.loadingOptions, M = computed(function() {
  ...
  return e.ref = "root", e.class = e.class ? ["echarts"].concat(e.class) : "echarts", h(C, e, [h("div", { ref: "inner" })]);
} });
export {
